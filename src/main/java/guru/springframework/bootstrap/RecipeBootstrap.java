...
public class RecipeBootstrap implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        log.debug("Adding all the necessary information into the database (Bootstrap)");
        this.recipeRepository.saveAll(this.getRecipes());

//        Recipe guacamole = new Recipe();
//        guacamole.getCategories().add(this.categoryRepository.findByDescription("Mexican").get());
//        guacamole.setCookTime(1);
//        guacamole.setDescription("How to Make Perfect Guacamole");
//        guacamole.setDifficulty(Difficulty.MODERATE);
//        guacamole.setDirections("1 Cut the avocado, remove flesh. - 2 Mash with a fork - 3 Add salt, lime juice, and the rest. - 4 Serve");
//        guacamole.setPrepTime(10);
//        guacamole.setServings(4);
//        guacamole.setSource("Simply Recipes - GUACAMOLE");
//        guacamole.setUrl("https://www.simplyrecipes.com/recipes/perfect_guacamole/");
//
//        guacamole = this.createGuacaIngredients(guacamole);
//
//        Notes notesForGuacamole = new Notes();
//        notesForGuacamole.setRecipe(guacamole);
//        notesForGuacamole.setRecipeNotes("TESTING ADDING RECIPE NOTES FOR GUACAMOLE");
//        guacamole.setNotes(notesForGuacamole);
//
//        //guacamole.setImage();
//
//        Recipe savedGuacamole = this.recipeRepository.save(guacamole);
//        System.out.println("======================== " + savedGuacamole + "=======================");
    }

//    private Recipe createGuacaIngredients(Recipe guacamole) {
//        Ingredient avocado = new Ingredient();
//        avocado.setDescription("Avocado");
//        avocado.setAmount(new BigDecimal(2));
//        avocado.setRecipe(guacamole);
//        avocado.setUom(this.unitOfMeasureRepository.findByDescription("Each").get());
//
//        Ingredient lime = new Ingredient();
//        lime.setDescription("Lime");
//        lime.setAmount(new BigDecimal(1));
//        lime.setRecipe(guacamole);
//        lime.setUom(this.unitOfMeasureRepository.findByDescription("Pinch").get());
//
...
//    }
    ...
    private List<Recipe> getRecipes() {
        ...
        //guacNotes.setRecipe(guacRecipe);
                // I do not need to execute line above anymore, as the method setNotes from the class Recipe is setting the bidirectional relationship. See line below.
                // It prevents the programmer not to forget to set the relationship between the entities.
        guacRecipe.setNotes(guacNotes);

        //guacRecipe.getIngredients().add(new Ingredient("ripe avocados", new BigDecimal(2), eachUom, guacRecipe));
        //NOTE: The lines below used to be like the line above. However, a method addIngredient(...) was added into the Recipe class that is setting the bidirectional relationship.
        //It prevents the programmer not to forget to set the relationship between the entities.
